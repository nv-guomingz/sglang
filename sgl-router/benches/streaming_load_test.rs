...
// This is a criterion benchmark, not a standalone binary
// To run: cargo bench streaming_load_test
// For standalone load testing, use: cargo run --release --bin load_test
